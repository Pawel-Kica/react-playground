export default function ProgressBar({ step }: { step: number }) {
    return (
        <header className="relative mb-6 flex">
            <div className="z-10">
                <div className="relative flex gap-12">
                    <div className="flex flex-col items-center">
                        ...
                        <div className={`${step >= 0 ? 'text-orange-m' : 'text-cyan-m'} mt-2 text-xs uppercase`}>
                            account setup
                        </div>
                    </div>
                    <div className="flex flex-col items-center">
                        ...
                        <div className={`${step >= 1 ? 'text-orange-m' : 'text-cyan-m'} mt-2 text-xs uppercase`}>
                            personal details
                        </div>
                    </div>
                    <div className="flex flex-col items-center">
                        ...
                        <div className={`${step >= 2 ? 'text-orange-m' : 'text-cyan-m'} mt-2 text-xs uppercase`}>
                            social profiles
                        </div>
                    </div>
                </div>
